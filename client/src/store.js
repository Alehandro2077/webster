...
export default class Store {
  ...
  getAuth() {
    ...
    console.log("getAuth is auth:", this.isAuth);
    return this.isAuth;
  }
  ...
  async checkAuth() {
    ...
    try {
      ...
      console.log("checkAuth res data", response.data);
      if (response.data == "auth: false") {
        this.setAuth(false);
        return;
      }
      this.setAuth(true);
      console.log("checkAuth isAuth:", this.getAuth());
      this.setUser(
        response.data.user.activated,
        response.data.user.email,
        response.data.user.id,
  ...
  // }
  /////////////////////////////////////////////////Project///////////////////////////////////////////
  async updateProject(files, title, state, projectId) {
    try {
      const formData = new FormData();
      formData.append("title", title);
      formData.append("state", state);
      formData.append("projectId", projectId);
      formData.append("img", files.name);
